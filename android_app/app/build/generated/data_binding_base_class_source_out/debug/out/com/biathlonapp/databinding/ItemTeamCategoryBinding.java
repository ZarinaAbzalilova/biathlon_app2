...
public final class ItemTeamCategoryBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static ItemTeamCategoryBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ItemTeamCategoryBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.item_team_category, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ItemTeamCategoryBinding bind(@NonNull View rootView) {
