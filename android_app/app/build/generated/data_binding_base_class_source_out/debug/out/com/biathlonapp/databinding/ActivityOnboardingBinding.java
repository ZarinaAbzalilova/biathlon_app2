...
public final class ActivityOnboardingBinding implements ViewBinding {
  ...
  private ActivityOnboardingBinding(@NonNull LinearLayout rootView,
      @NonNull MaterialButton buttonNext, @NonNull MaterialButton buttonSkip,
      @NonNull LinearLayout dotsContainer, @NonNull ViewPager2 viewPager) {
  ...
  public static ActivityOnboardingBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityOnboardingBinding((LinearLayout) rootView, buttonNext, buttonSkip,
          dotsContainer, viewPager);
    }
