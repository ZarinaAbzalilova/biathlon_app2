...
public final class FragmentAthletesBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentAthletesBinding(@NonNull LinearLayout rootView, @NonNull Button buttonRetry,
  ...
  @NonNull
  public static FragmentAthletesBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentAthletesBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_athletes, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentAthletesBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentAthletesBinding((LinearLayout) rootView, buttonRetry, layoutError,
